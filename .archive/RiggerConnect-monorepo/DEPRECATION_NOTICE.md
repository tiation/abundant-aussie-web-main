...
This repository (`RiggerConnect-monorepo`) contained duplicate or legacy content that has been:
...
```
/Users/tiaastor/Github/tiation-repos/.archive/RiggerConnect-monorepo/
```
