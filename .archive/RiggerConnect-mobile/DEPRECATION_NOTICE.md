...
This repository (`RiggerConnect-mobile`) contained duplicate or legacy content that has been:
...
```
/Users/tiaastor/Github/tiation-repos/.archive/RiggerConnect-mobile/
```
