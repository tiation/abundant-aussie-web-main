...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Dicerollersimulator</span>
    </h1>
    <p class="hero-subtitle">Professional dice rolling simulator with advanced gaming features and statistics</p>
    
    <div class="hero-stats">
      <div class="stat-item">
        <div class="stat-number">1M+</div>
        <div class="stat-label">Rolls Generated</div>
      </div>
      <div class="stat-item">
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/DiceRollerSimulator" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
- **🎯 Custom Dice Sets**: Advanced custom dice sets capabilities
- **🎯 Gaming Features**: Advanced gaming features capabilities
- **🎯 Mobile Ready**: Advanced mobile ready capabilities
- **🎯 Statistics**: Advanced statistics capabilities
...
### 🔧 Technology Stack
**HTML5, CSS3, JavaScript, Local Storage, Progressive Web App**
...
```bash
# Build Docker image
docker build -t DiceRollerSimulator .

# Run container
docker run -p 8080:8080 DiceRollerSimulator
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/DiceRollerSimulator)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/DiceRollerSimulator/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/DiceRollerSimulator/discussions)
...
- **Gaming**: Professional implementation
- **Education**: Professional implementation
- **Statistics**: Professional implementation
